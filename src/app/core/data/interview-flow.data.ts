...
export const INITIAL_STEPS: InterviewStep[] = [
  {
    ...
    summary: 'Angular starts at main.ts, configures providers in app.config.ts, then mounts the root component into index.html.',
    bullets: [
  ...
  },
  {
    ...
    summary: 'Local state lives in signal() values, and computed() creates derived values like progress and the active card.',
    bullets: [
  ...
  },
  {
    ...
    summary: 'The template uses @for and @if instead of legacy structural directives, which keeps the flow easier to read.',
    bullets: [
  ...
  },
  {
    ...
    summary: 'Tie everything together by describing the boot sequence, state flow, template bindings, and accessibility decisions.',
    bullets: [
